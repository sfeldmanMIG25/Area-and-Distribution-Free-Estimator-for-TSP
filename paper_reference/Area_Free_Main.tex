...
\begin{table}[!ht]
\centering
\caption{TSPLIB95 EUC\_2D benchmark by instance size (78 instances, four balanced buckets). SDPE is primary (first numeric column) and includes a 95\% bootstrap CI (1000 resamples, seed 42). GART 2.0 rows are bolded. \textit{Optimal solver} row shows mean \textsc{Concorde} wall time in milliseconds.}
...
\multirow{7}{*}{$[401,\,1500]$}
  ...
  & \textit{Optimal solver} & --- & --- & --- & --- & --- & 4{,}541{,}959 & --- \\
\midrule
\multirow{7}{*}{$n > 1500$}
  ...
  & \textit{Optimal solver} & --- & --- & --- & --- & --- & 1{,}341{,}641{,}880 & --- \\
\midrule
\multirow{7}{*}{\textbf{Total}}
  ...
  & \textit{Optimal solver} & --- & --- & --- & --- & --- & 591{,}595{,}588 & --- \\
\bottomrule
\end{tabular}%
}
\end{table}
