"""Splice new §5.2 through end of §6 (Application) into the tex file.
Replaces from '\\subsection{Datasets}' through the paragraph before '\\section{Conclusion}'.
"""
...
start_marker = "\\subsection{Datasets}"
...
print(f"Line at start: {lines[start_idx].rstrip()}")
print(f"Line at end  : {lines[end_idx].rstrip()}")
